...
/**
 * Tap-to-pick Day/Month/Year dropdown for an event's date — same full-screen
 * sheet pattern as DateOfBirthPicker, just with an ascending near-future
 * year range instead of a descending birth-year range. Still reports a
 * single "YYYY-MM-DD" string via onChange (only once all three are picked).
 */
